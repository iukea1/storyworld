  ...
  return (
    <main className="min-h-screen bg-warm-cream text-ink flex flex-col h-screen overflow-hidden">
      ...
      <header className="h-16 border-b border-ink/5 flex items-center justify-between px-6 shrink-0 bg-white z-20">
        ...
        <Button asChild size="sm" className="shadow-md shadow-ember/10">
          <Link href="/complete">
        ...
        <div className="w-full md:w-[60%] bg-parchment relative border-r border-ink/5 flex flex-col">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              />
              {/* Page Badge */}
              <Badge variant="outline" className="absolute top-4 right-4 bg-white/80 backdrop-blur-md text-ink border-ink/10 shadow-sm font-nunito font-bold text-xs">
                Page {activePage}
              </Badge>
              {/* Character Avatar */}
              <motion.div
          ...
          <div className="p-6 bg-white border-t border-ink/5 z-10">
            ...
            <div className="relative flex items-center">
              <Input
                ...
                className="rounded-full py-4 pl-6 pr-24 h-auto bg-parchment font-nunito placeholder:text-ink/40 focus-visible:border-ember focus-visible:ring-ember/20 shadow-inner"
              />
              <div className="absolute right-2 flex items-center gap-1">
                <Button variant="ghost" size="icon-sm" className="rounded-full text-ink/30 hover:text-horizon hover:bg-horizon/10">
                  <Mic className="w-5 h-5" />
                </Button>
                <Button variant="default" size="icon" className="shadow-md shadow-ember/20">
